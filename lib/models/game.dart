...
class Game {
  ...
  factory Game.fromJson(Map<String, dynamic> json) {
    List<GameOdds> odds = json['odds'].map<GameOdds>((json) {
      return GameOdds.fromJson(json);
    }).toList();

    return Game(
      schedule: GameSchedule.fromJson(json['schedule']),
      summary: json['summary'],
      details: GameDetails.fromJson(json['details']),
      status: json['status'],
      teams: GameTeams.fromJson(json['teams']),
      lastUpdated: DateTime.parse(json['lastUpdated']),
      gameId: json['gameId'],
      venue: GameVenue.fromJson(json['venue']),
      odds: odds,
    );
  }

  static Future<String> _loadGamesJsonAsset() async {
    return rootBundle.loadString(jsonAssetPath);
  }

  static Future<List<Game>> fetchAllFromMock() async {
    final dynamic gamesJson = json.decode(await _loadGamesJsonAsset());
